						...
						<div class="w3l-table-info agile_info_shadow">
								...
								<div class="col-sm-3" style="border: solid 1px #d6d6d6;padding: 10px;">
									...
									<ul class="nav nav-pills nav-stacked">
									  ...
									  <li class="active"><a href="/ejecucion_reporte/{{$id}}">Reporte HO/SNC</a></li>
									  <?php }
									  }
								...
								<div class="col-sm-9" >
									<br>
									<h4 style="text-align: center;">REPORTE DE HALLAZGO OPERACIONAL / SERVICIO NO CONFORME</h4>
									<br><br>
											    			...
											    			<?php
													     		if(!empty($listadoc)){
													     			...
													     			foreach ($listadoc as $row) {
																		...
																		<button type='button' class='btn btn-primary' data-dismiss='modal' aria-label='Close' onclick=datos_doc_ho('$row->idreporteho')>Ver más</button>
													     				</td></tr>";
													     				$contador+=1;
													     			}
													     		}
									...
									<div class="col-sm-5">
											<input type="hidden" name="idreporteho" id="idreporteho" value="{{$idreporteho}}">
									...
									<div class="col-sm-3">
									<button type="button" class="btn btn-default" onclick="guardarReporte();" >Guardar</button>
									</div>
									...
									<embed src="../documentos/reporteho/{{$archivo}}" width="100%" height="600">
									</div>
									...
									<button type="button" class="btn btn-default" onclick="eliminarReporte({{$id}});" >Eliminar</button>
									</div>
