						...
						<div class="w3l-table-info agile_info_shadow">
								...
								<div class="col-sm-3" style="border: solid 1px #d6d6d6;padding: 10px;">
									...
									<ul class="nav nav-pills nav-stacked">
									  ...
									  <li class="active"><a href="/inicio_matrizriesgos/{{$id}}">Matriz de Riesgos</a></li>
									  <?php } 
								...
								<div class="col-sm-9" >
									...
									<div id="resultadomatrizriesgos">

									<div class="col-xs-12 col-sm-3">
									<a  @if ($accion == 1) {{'disabled'}} @endif href="../documentos/matriz_riesgos/{{$archivo}}" download="{{$doc}}"><button type="button" class="btn btn-default"  @if ($accion == 1) {{'disabled'}} @endif>Descargar</button> </a>
									</div>
									...
									<div class="col-xs-12 col-sm-3">
									<button type="button" class="btn btn-default" onclick="guardarMatrizRiesgos();">Guardar</button> 
									</div>
