						...
						<div class="w3l-table-info agile_info_shadow">
								...
								<div class="col-sm-3" style="border: solid 1px #d6d6d6;padding: 10px;">
									...
									<ul class="nav nav-pills nav-stacked">
									  ...
									  <li class="active"><a href="/inicio_matrizrol/{{$id}}">Matriz de Roles</a></li>
									  <?php }
								...
								<form id="frommatrizresol" action="/inicio/matrizrol" method="post">
								...
								<div class="col-sm-9" >
									<br>
									<h4 style="text-align: center;">MATRIZ DE ROLES - RACI</h4>
									<br><br>
									...
									<div class="col-sm-9">
										<textarea   name="descripcion" id="descripcion" cols="0" rows="10" class="form-control1 wsg"  >{{$descripcion}}</textarea>
									</div>
									</div>
									...
									<div id="resultadomatrizresol">

									<div class="col-xs-12 col-sm-3">
									<a  @if ($accion == 1) {{'disabled'}} @endif href="../documentos/matriz_roles/{{$archivo}}" download="{{$doc}}"><button type="button" class="btn btn-default"  @if ($accion == 1) {{'disabled'}} @endif>Descargar</button> </a>
									</div>
									...
									<div class="col-xs-12 col-sm-3">
									<button type="button" class="btn btn-default" onclick="guadarMatrizRol();">Guardar</button>
									</div>
